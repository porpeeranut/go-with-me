...
<button id="btn_add" onclick="window.document.location='main.php?option=add&TYPE=timing';" class="btn btn-default">Add</button>
    ...
    $(document).ready(function(){
        ...
        function showData(obj) {
            ...
            for (i=0;i<obj.data.length;i++) {
                ...
                row += '<a href="#">';
                row += '<img onclick="window.document.location=\'main.php?option=badge_type_detail&TYPE=times&ID='+ID+'&NAME='+NAME+'&DETAIL='+DETAIL+'\';" class="img-responsive" src="images/times/'+obj.data[i].ID+'.jpg" alt="">';
                row += '</a>';
                row += '<h3>';
                row += obj.data[i].ID;
                row += '</h3>';
